defmodule DeuchainnWeb.TweetControllerTest do
  use DeuchainnWeb.ConnCase

  alias Deuchainn.Signups

  @create_attrs %{adress: "some adress", twitter: "some twitter", user: "some user"}
  ...
  def fixture(:tweet) do
    {:ok, tweet} = Signups.create_tweet(@create_attrs)
    tweet
  end
